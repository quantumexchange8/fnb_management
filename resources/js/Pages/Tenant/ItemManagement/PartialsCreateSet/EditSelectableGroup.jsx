    ...
    const fetchMealItem = async () => {
        setIsLoading(true);
         ...
         try {
            ...
            const currentSelectedMap = new Map(mealItems.map(item => [item.product?.id, item]));
            ...
            >
                {
                    selectedEditOption && (
                        <div className="flex flex-col gap-5 px-5 py-4">
                            <div className="flex items-center gap-4 border rounded-lg p-2">
                                {
                                    selectedEditOption.product ? (
                                        <img
                                            src={selectedEditOption.product.product_image}
                                            alt={selectedEditOption.product.item_code}
                                ...
                                }
                                {
                                    selectedEditOption.product ? (
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 font-semibold text-neutral-900 text-base">
                                                <span>{selectedEditOption.product.item_code}</span>
                                                <span className=" truncate">{selectedEditOption.product.name}</span>
                                            </div>
                                            <div className="text-base text-neutral-900">RM {selectedEditOption.product.prices}</div>
                                        </div>
                                    ) : (
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 font-semibold text-neutral-900 text-base">
                                                            ...
                                                            <div className="flex items-center gap-4 w-full">
                                                                ...
                                                                <div className="flex flex-col gap-1 w-full">
                                                                    <div className="text-neutral-900 text-base font-bold">
                                                                        {
                                                                            opt.item_code ? (
                                                                                <>{opt.item_code} {opt.name}</>
                                                                            ) : (
                                                                                <>{opt.product.item_code} {opt.product.name}</>
                                                                            )
                                                                        }
